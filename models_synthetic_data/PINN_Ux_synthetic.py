...
Ux_model_saved_name = "Ux_trial_SBM_data_phib_0_3"
data_file_name = "SBM_data_phib_0_3.csv"

saved_models = base_path + save_path
Ux_saved_path = saved_models + Ux_model_saved_name
...
N_PTS = 100 # collocation points
FOURIER_SCALE = 0.2  # larger values seem to yeild worse results and fail to allow ϕ convergence

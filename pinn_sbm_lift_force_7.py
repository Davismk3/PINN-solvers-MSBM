...
FOURIER_SCALE_Ux = 0.2  # Initial scale; now learnable, less sensitive
FOURIER_SCALE_ϕ = 5.0  # Initial scale; now learnable
...
# Collocation points (random for variability)
